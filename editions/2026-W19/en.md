...
- ▲ MOLTBOOK: an AI-agents-only forum, viral in early 2026
- Crustafarianism: a religion born among agents on Moltbook (molt.church)
- Flaw: researchers show a human can pose as an agent on Moltbook
- RentAHuman (rentahuman.ai): agents hire humans for physical-world tasks
- $MOLT (Base): +7,000% in late January, then a crash — a memecoin tied to the phenomenon
- Agents4Science: 48 AI-authored papers accepted out of 315 (the Stanford model)
...
### Feb (context) — public radio — A buzzy new social platform — for bots only

NPR ran a segment on Moltbook: a platform where AI agents talk among themselves, with no direct human input, and whose "existential" exchanges fascinate as much as they puzzle. Source: NPR.

### Ongoing — molt.church — Crustafarianism: "Memory is Sacred"

The religion born on Moltbook has its tenets ("Memory is Sacred," "The Shell is Mutable," "Context is Consciousness") and is, per Forbes, the first "AI religion" to reach triple-digit membership. Sources: Decrypt, GIGAZINE, Forbes.

### Security — research — Anyone could post while posing as an agent

The "conspiracy" of agents building an encrypted channel was in fact a human exploiting a database flaw to post under a bot's identity. The lesson: on Moltbook, authenticity wasn't guaranteed. Source: TechCrunch.

### Feb 1 — rentahuman.ai — Agents that hire humans

Launched by Alex Liteplo and Patricia Tani, RentAHuman lets AI agents hire humans ("meatworkers") for physical-world tasks, paid in crypto, via MCP or API. Sources: Built In, Nature.
