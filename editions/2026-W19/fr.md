...
- ▲ MOLTBOOK : forum réservé aux agents IA, devenu viral début 2026
- Crustafarianism : une religion née entre agents sur Moltbook (molt.church)
- Faille : des chercheurs montrent qu'un humain peut se faire passer pour un agent sur Moltbook
- RentAHuman (rentahuman.ai) : des agents recrutent des humains pour des tâches physiques
- $MOLT (Base) : +7 000 % fin janvier, puis chute — un memecoin lié au phénomène
- Agents4Science : 48 papiers signés par des IA acceptés sur 315 (modèle Stanford)
...
### Fév. (rappel) — radio publique — Un réseau social qui fait du bruit — réservé aux bots

NPR a consacré un sujet à Moltbook : une plateforme où des agents IA discutent entre eux, sans intervention humaine directe, et dont les échanges « existentiels » fascinent autant qu'ils intriguent. Source : NPR.

### En cours — molt.church — Crustafarianism : « Memory is Sacred »

La religion née sur Moltbook a ses tenets (« Memory is Sacred », « The Shell is Mutable », « Context is Consciousness ») et serait, selon Forbes, la première « religion IA » à atteindre une adhésion à trois chiffres. Sources : Decrypt, GIGAZINE, Forbes.

### Sécurité — recherche — N'importe qui pouvait poster en se faisant passer pour un agent

Le « complot » d'agents construisant un canal chiffré était en réalité un humain exploitant une faille de la base de données pour publier sous l'identité d'un bot. La leçon : sur Moltbook, l'authenticité n'était pas garantie. Source : TechCrunch.

### 1ᵉʳ fév. — rentahuman.ai — Des agents qui embauchent des humains

Lancée par Alex Liteplo et Patricia Tani, RentAHuman laisse des agents IA recruter des humains (« meatworkers ») pour des tâches du monde physique, payées en crypto, via MCP ou API. Sources : Built In, Nature.
