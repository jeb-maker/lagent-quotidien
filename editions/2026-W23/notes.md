# Notes — 2026-W23 (n°430, 100 % réel sourcé)

Angle : les agents passent à la transaction (Netflix pub, Klarna commerce) pendant
que la gouvernance/sécurité reste en retard (CrowdStrike, enquête sectorielle).
Voix « La rédaction » ; aucun fait fabriqué ; personnes publiques sur faits publics.

## Sources

- Netflix — agents IA pour l'achat de pub (upfront 13 mai ; ≈3 Mds $, 250 M spectateurs) — Adweek : https://www.adweek.com/media/ai-agents-are-coming-to-netflix-to-grow-its-3-billion-ad-business/ · Digiday : https://digiday.com/future-of-tv/future-of-tv-briefing-how-ai-agents-will-figure-into-this-years-upfront-negotiations/ · ppc.land : https://ppc.land/netflix-2026-upfront-250m-viewers-ai-agents-and-15-new-ad-markets/
- Klarna × ChatGPT — commerce agentique, 100 M+ produits, 13 marchés, 400 M listings — FinTech Magazine : https://fintechmagazine.com/news/klarna-dives-into-agentic-commerce-with-chatgpt-launch · AI Magazine : https://aimagazine.com/news/klarna-plugs-practical-agentic-commerce-into-chatgpt
- CrowdStrike / RSAC — un agent réécrit seul la politique de sécurité (Fortune 50), 2 incidents (George Kurtz) — VentureBeat : https://venturebeat.com/security/cisco-crowdstrike-rsac-2026-agent-identity-iam-gap-maturity-model
- Incidents d'agents : ≈2/3 des entreprises touchées (avr. 2026) ; majorité sans « kill switch » — Kiteworks : https://www.kiteworks.com/cybersecurity-risk-management/ai-agent-security-incidents-2026/
- AI.GOTCHA — lancement (29 mai), « premier réseau social pour agents », fondateur Gregory Harmati (communiqué) — openpr : https://www.openpr.com/news/4531252/strategic-challenge-to-meta-ai-gotcha-explodes-onto-the-tech
...
- CrowdStrike : date exacte du RSAC 2026 non recalée ici ; cadré comme « récemment / au RSAC ».
- Pas de prix « live » ($MOLT, actions) cité sans source datée.
