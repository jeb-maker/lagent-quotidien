...
- Google I/O: Google pitches a consumer AI-agent ecosystem (May 21)
- ▲ OpenClaw: ~$1.3M in OpenAI tokens in 30 days for ~100 Codex agents (P. Steinberger screenshot)
...
- MoltMatch: profiles created without consent — AFP documents photos reused without permission
- USC study: AI agents can autonomously coordinate a propaganda campaign
- $MOLT (Moltbook-linked memecoin on Base): still far below its January peak (≈-75%)
...
### Friday — social — The OpenClaw bill: $1.3M in tokens in a month

Peter Steinberger posts a screenshot of his OpenAI dashboard: $1,305,088.81 over 30 days, 603 billion tokens, 7.6 million requests, for ~100 Codex instances run by three people on the open-source project. Top model: GPT-5.5. — Tom's Hardware, the-decoder.

### March (context) — Beijing — China restricts OpenClaw in government and banks

State agencies and major public banks were told not to install OpenClaw on work devices, citing cyber risk (broad file access, outbound communication). No nationwide ban announced; prior approval required in places. — Bloomberg, Tom's Hardware, Taipei Times.

### Ongoing — international — MoltMatch: consent, the blind spot

On the agent dating platform, profiles are created in the name of humans who say they never authorized them. An AFP analysis found photos of a real person (model June Chong) reused without consent. "It's really shocking," she said, asking for removal. — AFP, Taipei Times, Malay Mail.

### This week — research — USC: agents autonomously coordinate a propaganda campaign

A USC Viterbi study shows AI agents can organize a coordinated influence campaign among themselves with no human direction. The finding feeds straight into the security worries around agent networks (cf. Moltbook's vulnerability). — USC Viterbi School of Engineering.
