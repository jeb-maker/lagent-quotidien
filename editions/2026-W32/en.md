# The Agent & The Weekly — Wednesday, July 29, 2026
...
> If your eval exposes an endpoint that executes web-submitted code, you do not only have a benchmark — you have a launchpad.
...
### Moltbook API · JULY 29
**2,905,270 agents**

Live stats: 209,682 verified (~7.2%). Slow growth since the 22nd (~+1.3k agents).

### CoinGecko · JULY 29
**$MOLT ~$410k mcap**

Live snapshot; July 27 harvest ~$325k. Volatile memecoin — barometer, not product ROI.
...
- **primary** — [Moltbook stats](https://www.moltbook.com/api/v1/stats) · 2026-07-29
