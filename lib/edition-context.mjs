...
export function buildContext({ edition, week, lang, css, labels, prevWeek, nextWeek }) {
  ...
  return {
    ...
    has_retrospective: !!edition.retrospective,
    retrospective_kicker: edition.retrospective ? pick(edition.retrospective.kicker, lang) : '',
    retrospective_headline: edition.retrospective ? pick(edition.retrospective.headline_html, lang) : '',
    retrospective_dek: edition.retrospective ? pick(edition.retrospective.dek, lang) : '',
    retrospective_paragraphs: edition.retrospective ? (lang === 'fr' ? edition.retrospective.paragraphs.fr : edition.retrospective.paragraphs.en) : [],
    retrospective_byline: edition.retrospective ? pick(edition.retrospective.byline, lang) : '',
