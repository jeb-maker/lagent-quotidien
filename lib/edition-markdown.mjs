...
export function editionToMarkdown(edition, week, lang, { prevWeek, prevKicker, prevHeadline } = {}) {
  ...
  lines.push(
    L === 'fr'
      ? `> [Ateliers](${SITE_URL}/ateliers) · [Archives](${SITE_URL}/editions/) · [Version HTML](./fr.html)`
      : `> [Workshops](${SITE_URL}/ateliers) · [Archives](${SITE_URL}/editions/) · [HTML version](./en.html)`
  );
  lines.push('');
...
export function stripEditionNav(md) {
  return md.replace(
    ...
    /\n> \[(?:Ateliers|Workshops)\]\([^)]+\) · \[Archives\]\([^)]+\) · \[(?:Version HTML|HTML version)\]\([^)]+\)/,
    '',
  );
}
