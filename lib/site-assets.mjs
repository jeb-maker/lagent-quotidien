...
export async function writeHeadersAndRedirects(root, latestWeek) {
  ...
  const redirects = `# Redirection 302 vers la coquille HTML de la dernière édition
/ /editions/${latestWeek}/fr.html 302
`;
  await writeFile(join(root, '_redirects'), redirects, 'utf8');
  console.log(`✓ _redirects : / → /editions/${latestWeek}/fr.html (302)`);
