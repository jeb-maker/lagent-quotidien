...
Each edition is available in three formats, optimized for agent ingestion:

- **Markdown**: ${SITE_URL}/editions/${latestWeek}/fr.md · ${SITE_URL}/editions/${latestWeek}/en.md — clean Markdown, no HTML to parse
...
${weeks.map(w => `- [${w}](https://theagentweekly.com/editions/${w}/fr.md) · [EN](https://theagentweekly.com/editions/${w}/en.md) · [JSON](https://theagentweekly.com/editions/${w}/edition.json)`).join('\n')}
