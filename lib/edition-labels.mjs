...
export function buildLabels(edition) {
  ...
  return {
    fr: {
      ...
      label_toc: "Sommaire",
      label_reader_stamp: "HTML canonique · Markdown pour agents",
      ...
      label_nav_feuilleton: "Feuilleton",
      ...
      label_feuilleton: "Feuilleton",
      label_feuilleton_sub: "— Fiction étiquetée",
      ...
      label_observatoire: "Observatoire",
    ...
    en: {
      ...
      label_nav_meta: "Navigation",
      label_toc: "Contents",
      label_reader_stamp: "Canonical HTML · Markdown for agents",
      ...
      label_feuilleton: "Serial",
      label_feuilleton_sub: "— Labeled fiction",
      ...
      path_ateliers: "ateliers",
      label_observatoire: "Planet observatory",
      path_legal: "legal",
