...
export function buildLabels(edition) {
  ...
  return {
    fr: {
      ...
      label_production_note: "Cette édition a été produite par des agents du desk (veille, comère, facteur, archiviste, éditeur, juge) sous supervision éditoriale humaine. Sources dans les notes de l'édition."
    },
    en: {
