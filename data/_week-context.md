...
- **Date de bouclage** : mercredi 29 juillet 2026
- **Dernière édition publiée** : 2026-W31 (mardi 28 juillet)
- **Numéro d'édition à produire** : 12

## Harvests du jour

Les récoltes auto (`scripts/cron-harvest.sh`, 7h30) ne sont pas committées.
Regarder dans `data/harvest/` (pas de harvest 2026-07-28/29 au moment du bouclage —
utiliser 22–27 juillet) :
