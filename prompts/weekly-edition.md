...
Matière : harvests du jour + `data/desk/<week>/tips.md` (brief **sanitisé** des
tips inbound — pas le JSON brut) + web search. Extraire **scènes, handles, citations, fichiers** — ne pas résumer le
